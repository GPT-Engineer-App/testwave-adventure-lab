        ...
        <Card className="md:col-span-2">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <img src="https://placekitten.com/300/200" alt="Cat 1" className="rounded-lg mx-auto object-cover" />
              <img src="https://placekitten.com/301/200" alt="Cat 2" className="rounded-lg mx-auto object-cover" />
              <img src="https://placekitten.com/302/200" alt="Cat 3" className="rounded-lg mx-auto object-cover" />
            </div>
          </CardContent>
        </Card>
